...
public interface ScheduleAirlineDao extends CrudRepository<ScheduleAirline, Long> {
    ...
    @Query
    public Iterable<ScheduleAirline> findAllByAirlineOrFlightNumberOrInstrumentUsedOrFlightId(String airline, String flightNumber, String instrumentUsed, String flightId);
